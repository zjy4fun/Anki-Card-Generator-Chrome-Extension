    ...
    return (
        <div className="flex flex-col items-center p-6 bg-gray-100">
            ...
            <div className="my-6 flex w-full justify-between items-center">
                <div className="w-1/3">
                    <label className="text-xl font-semibold text-gray-700">OpenAI API URL:</label>
                </div>
            ...
            <div className="my-6 flex w-full justify-between items-center">
                <div className="w-1/3">
                    <label className="text-xl font-semibold text-gray-700">Model Name:</label>
                </div>
                <div className="relative w-3/4">
                    <input
                        type={'text'}
                        placeholder="ERNIE-Speed-8K"
                        value={openAIUrl}
                        onChange={(e) => {
